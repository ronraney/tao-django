...
urlpatterns = [
    ...
    path('writers/', views.WriterListView.as_view(), name='writer_lists'),
    path('writer/<int:pk>/', views.WriterDetailView.as_view(), name='writer_detail'),
    path('translators/', views.TranslatorListView.as_view(), name='translator_list'),
    path('translator/<int:translator_id>/', views.TranslatorDetailView.as_view(), name='translator_detail'),
